package com.david.timecard.fragment;
...
import com.david.timecard.BaseFragment;
...
public class ScheduleFragment extends BaseFragment implements SelectorAdapter.OnItemClickListener {
    ...
    private void getDataSchedule(int position) {
        ...
        List<ScheduleBean> scheduleBeans = Arrays.asList(bean01, bean02, bean03, bean01, bean02, bean03);
